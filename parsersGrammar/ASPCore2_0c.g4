...
statementsForTest:
	statementForTest statementsForTest?;
...
inputTest: 'input' EQUAL '\'' statementsForTest '\'';
...
trueInAll: 'trueInAll' PAREN_OPEN 'atoms' EQUAL '\'' (classical_literal DOT)+ '\'' PAREN_CLOSE;
trueInAtLeast: 'trueInAtLeast' PAREN_OPEN 'number' EQUAL NUMBER COMMA 'atoms' EQUAL '\'' (classical_literal DOT)+ '\'' PAREN_CLOSE;
trueInAtMost:'trueInAtMost' PAREN_OPEN 'number' EQUAL NUMBER COMMA 'atoms' EQUAL '\'' (classical_literal DOT)+ '\'' PAREN_CLOSE;
trueInExactly:'trueInExactly' PAREN_OPEN 'number' EQUAL NUMBER COMMA 'atoms' EQUAL '\'' (classical_literal DOT)+ '\'' PAREN_CLOSE;
constraintIn: (constraintForAll
		| constraintInAtLeast
		| constraintInAtMost
		| constraintInExactly);
constraintEqual: 'constraint' EQUAL '\''CONS body? DOT'\'';
